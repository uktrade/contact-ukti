...
module.exports = forms.create({
  ...
  'enquiry-summary': fields.string({
    label: 'Provide a brief summary of the assistance you require',
    required: validators.required('is required'),
    widget: widgets.textarea({ rows: 6 }),
  }),
  'how-you-heard-about-us': fields.array({
    required: validators.required('is required'),
