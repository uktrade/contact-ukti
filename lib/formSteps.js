...
var validators = require('./formValidators');
...
var steps = [
  {
    ...
    fields: {
      'enquiry-type': fields.string({
        ...
        legendClasses: ['form-label-bold'],
        widget: widgets.multipleRadio(),
        choices: {
          'Export': 'Exporting from the UK or investing overseas (for UK companies)',
          'Investment': 'Inward investment into the UK (for non-UK companies)',
          'BisOps': 'Business opportunities service',
          'DSO': 'UK Trade & Invesment Defence and Security Organisation (DSO)',
          'Events': 'UK Trade & Investment events',
          'Other': 'Other',
        },
      }),
      'your-reason': fields.string({
        label: 'Your reason',
        cssClasses: ['panel-indent'],
        dataAttrs: {
          'control-value': 'Other',
          'controlled-by': 'enquiry-type'
        },
        validators: [
          validators.requiresFieldIfFieldEquals('enquiry-type', 'Other', 'is required'),
        ]
      }),
    },
  },
